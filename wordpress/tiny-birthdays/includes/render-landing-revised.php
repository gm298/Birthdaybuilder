    ...
    <section class="packages" id="packages">
      ...
      <div class="pkg-compact" id="packages-compact">
        <div class="pkg-compact__item is-open is-featured" data-pkg="signature">
          ...
          <div class="pkg-compact__panel"><span class="pkg-compact__summary">10 guests · cake 18cm · themed decor · medium balloons · photozone</span><a class="pkg-compact__cta" href="<?php echo $builder_signature; ?>">Customise this →</a></div>
        </div>
        <div class="pkg-compact__item" data-pkg="simple">
          ...
          <div class="pkg-compact__panel" hidden><span class="pkg-compact__summary">5 guests · cake 15cm · themed party · table &amp; balloon decor</span><a class="pkg-compact__cta" href="<?php echo $builder_simple; ?>">Customise this →</a></div>
        </div>
        <div class="pkg-compact__item" data-pkg="terrace">
          ...
          <div class="pkg-compact__panel" hidden><span class="pkg-compact__summary">20 guests · private terrace · photozone · dessert station · masterclass</span><a class="pkg-compact__cta" href="<?php echo $builder_terrace; ?>">Customise this →</a></div>
        </div>
      </div>
